<template>
  <div class="params">
    ...
    <div class="header">
      ...
      <el-button type="primary" @click="showParams" icon="el-icon-plus">添加</el-button>
    </div>
    ...
    <el-table :data="tableData" class="my-table">
      ...
      <el-table-column prop="specsName" label="课程名称" width="120">
      </el-table-column>
      <el-table-column prop="paramData" label="课程介绍" show-overflow-tooltip>
      </el-table-column>
